...
extern __interrupt void motorCtrlISR(void);
...
// M1
#define MTR1_HALLBLDC_A_GPIO_MUX	GPIO_44_GPIO44
#define MTR1_HALLBLDC_A_GPIO		44

#define MTR1_HALLBLDC_B_GPIO_MUX	GPIO_37_GPIO37
#define MTR1_HALLBLDC_B_GPIO		37

#define MTR1_HALLBLDC_C_GPIO_MUX	GPIO_43_GPIO43
#define MTR1_HALLBLDC_C_GPIO		43

// M2
#define MTR2_HALLBLDC_A_GPIO_MUX	GPIO_14_GPIO14
#define MTR2_HALLBLDC_A_GPIO		14

#define MTR2_HALLBLDC_B_GPIO_MUX	GPIO_25_GPIO25
#define MTR2_HALLBLDC_B_GPIO		25

#define MTR2_HALLBLDC_C_GPIO_MUX	GPIO_26_GPIO26
#define MTR2_HALLBLDC_C_GPIO		26
#endif
...
//M2
#define MTR2_CAP_U_BASE         ECAP1_BASE
#define MTR2_CAP_V_BASE         ECAP2_BASE
#define MTR2_CAP_W_BASE         ECAP3_BASE

#define MTR2_CAP_U_XBAR         XBAR_INPUT4
#define MTR2_CAP_V_XBAR         XBAR_INPUT5
#define MTR2_CAP_W_XBAR         XBAR_INPUT6

#define MTR2_CAP_U_INSEL        ECAP_INPUT_INPUTXBAR4
#define MTR2_CAP_V_INSEL        ECAP_INPUT_INPUTXBAR5
#define MTR2_CAP_W_INSEL        ECAP_INPUT_INPUTXBAR6
...
#define MTR2_IV_ADC_SOC_NUM     ADC_SOC_NUMBER9         // ADCC-A9/C8*  -SOC7-PPB3
#define MTR2_IW_ADC_SOC_NUM     ADC_SOC_NUMBER11        // ADCC-A4/C14* -SOC8-PPB4
...
static inline void PWM_setOneShotTrip(uint32_t pwmBase)
{
    // set the bits
	EPWM_forceTripZoneEvent(pwmBase, EPWM_TZ_FORCE_EVENT_OST);
...
//! \param[in] pwmHandle  The pulse width modulation (PWM) object handle
static inline void PWM_clearOneShotTrip(uint32_t pwmBase)
{
	EPWM_clearTripZoneFlag(pwmBase, EPWM_TZ_FLAG_OST);
...
{
    // Motor_1->ADCA_INT1
    Interrupt_register(MTR1_PIE_INT_NUM, &motorCtrlISR);
...
static __UNUSED ALWAYSINLINE void HAL_readMtrADCData(HAL_ADCData_t *pADCData , const MotorNum_e motorNum)
{
    float32_t value;
...
//! \param[in]  handle  The hardware abstraction layer (HAL) handle
extern void HAL_setupCAPs(HAL_MTR_Handle handle, MotorNum_e motorNum);
