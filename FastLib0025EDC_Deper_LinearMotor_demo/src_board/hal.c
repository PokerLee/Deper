...
#if HALL_FAST
    // initialize CAP handles for Motor 1
    obj->capHandle[0] = MTR2_CAP_U_BASE;        //!< the CAP handle
    obj->capHandle[1] = MTR2_CAP_V_BASE;        //!< the CAP handle
    obj->capHandle[2] = MTR2_CAP_W_BASE;        //!< the CAP handle
#endif
...
#if HALL_FAST
void HAL_setupCAPs(HAL_MTR_Handle handle, MotorNum_e motorNum)
{
    ...
    if(motorNum == MTR_1)
    {
        XBAR_setInputPin(INPUTXBAR_BASE, MTR1_CAP_U_XBAR, MTR1_HALLBLDC_A_GPIO);
        XBAR_setInputPin(INPUTXBAR_BASE, MTR1_CAP_V_XBAR, MTR1_HALLBLDC_B_GPIO);
        XBAR_setInputPin(INPUTXBAR_BASE, MTR1_CAP_W_XBAR, MTR1_HALLBLDC_C_GPIO);
...
//    {
//        XBAR_setInputPin(INPUTXBAR_BASE, MTR2_CAP_U_XBAR, MTR2_HALLBLDC_A_GPIO);
//        XBAR_setInputPin(INPUTXBAR_BASE, MTR2_CAP_V_XBAR, MTR2_HALLBLDC_B_GPIO);
//        XBAR_setInputPin(INPUTXBAR_BASE, MTR2_CAP_W_XBAR, MTR2_HALLBLDC_C_GPIO);
//
//        ECAP_selectECAPInput(obj->capHandle[0], MTR2_CAP_U_INSEL);
//        ECAP_selectECAPInput(obj->capHandle[1], MTR2_CAP_V_INSEL);
//        ECAP_selectECAPInput(obj->capHandle[2], MTR2_CAP_W_INSEL);
//    }
...
//    ADC_setSOCPriority(PFC_IAC_ADC_BASE, ADC_PRI_SOC0_HIPRI);
    ...
    ADC_setupSOC(MTR1_VU_ADC_BASE, ADC_SOC_NUMBER2  , MTR1_ADC_TIGGER_SOC,
                     	 MTR1_VU_ADC_CH_NUM, MTR2_ADC_V_SAMPLEWINDOW);
    ...
    ADC_setupSOC(MTR1_VV_ADC_BASE, ADC_SOC_NUMBER4, MTR1_ADC_TIGGER_SOC,
                     	 MTR1_VV_ADC_CH_NUM, MTR2_ADC_V_SAMPLEWINDOW);
	...
	ADC_setupSOC(MTR1_VW_ADC_BASE, ADC_SOC_NUMBER4  , MTR1_ADC_TIGGER_SOC,
				 	 	 MTR1_VW_ADC_CH_NUM, MTR2_ADC_V_SAMPLEWINDOW);
...
//
//    // ISEN_A_M1
//    ADC_setupSOC(MTR1_IU_ADC_BASE, ADC_SOC_NUMBER6, MTR1_ADC_TIGGER_SOC,
//                     	 MTR1_IU_ADC_CH_NUM, MTR1_ADC_I_SAMPLEWINDOW);
//
//    ADC_setupSOC(MTR1_IU_ADC_BASE, MTR1_IU_ADC_SOC_NUM, MTR1_ADC_TIGGER_SOC,
//                 	 	 MTR1_IU_ADC_CH_NUM, MTR1_ADC_I_SAMPLEWINDOW);
//
//    // ISEN_B_M1
//    ADC_setupSOC(MTR1_IV_ADC_BASE, ADC_SOC_NUMBER8  , MTR1_ADC_TIGGER_SOC,
//                     	 MTR1_IV_ADC_CH_NUM, MTR1_ADC_I_SAMPLEWINDOW);
//
//    ADC_setupSOC(MTR1_IV_ADC_BASE, MTR1_IV_ADC_SOC_NUM, MTR1_ADC_TIGGER_SOC,
//                 	 	 MTR1_IV_ADC_CH_NUM, MTR1_ADC_I_SAMPLEWINDOW);
...
//
//    // VSEN_A_M1
//    ADC_setupSOC(MTR1_VU_ADC_BASE, ADC_SOC_NUMBER8  , MTR1_ADC_TIGGER_SOC,
//                     	 MTR1_VU_ADC_CH_NUM, MTR2_ADC_V_SAMPLEWINDOW);
//
//    ADC_setupSOC(MTR1_VU_ADC_BASE, MTR1_VU_ADC_SOC_NUM, MTR1_ADC_TIGGER_SOC,
//                 	 	 MTR1_VU_ADC_CH_NUM, MTR2_ADC_V_SAMPLEWINDOW);
//
//    // VSEN_B_M1
//    ADC_setupSOC(MTR1_VV_ADC_BASE, ADC_SOC_NUMBER10, MTR1_ADC_TIGGER_SOC,
//                     	 MTR1_VV_ADC_CH_NUM, MTR2_ADC_V_SAMPLEWINDOW);
//
//    ADC_setupSOC(MTR1_VV_ADC_BASE, MTR1_VV_ADC_SOC_NUM, MTR1_ADC_TIGGER_SOC,
//                 	 	 MTR1_VV_ADC_CH_NUM, MTR2_ADC_V_SAMPLEWINDOW);
//
//    // VSEN_C_M1
//	ADC_setupSOC(MTR1_VW_ADC_BASE, ADC_SOC_NUMBER12  , MTR1_ADC_TIGGER_SOC,
//				 	 	 MTR1_VW_ADC_CH_NUM, MTR2_ADC_V_SAMPLEWINDOW);
//
//	ADC_setupSOC(MTR1_VW_ADC_BASE, MTR1_VW_ADC_SOC_NUM  , MTR1_ADC_TIGGER_SOC,
//				 	 	 MTR1_VW_ADC_CH_NUM, MTR2_ADC_V_SAMPLEWINDOW);
...
//    // VSEN_DCBUS-->Trig Interrupt
//
//	ADC_setupSOC(MTR1_VDC_ADC_BASE, ADC_SOC_NUMBER14 , MTR1_ADC_TIGGER_SOC,
//                 	 	 MTR1_VDC_ADC_CH_NUM, MTR1_ADC_V_SAMPLEWINDOW);
//
//	ADC_setupSOC(MTR1_VDC_ADC_BASE, MTR1_VDC_ADC_SOC_NUM , MTR1_ADC_TIGGER_SOC,
//                 	 	 MTR1_VDC_ADC_CH_NUM, MTR1_ADC_V_SAMPLEWINDOW);
//	//////////////////////////
    ...
    // ISEN_B_M2
    ADC_setupSOC(MTR2_IV_ADC_BASE, ADC_SOC_NUMBER8, MTR2_ADC_TIGGER_SOC,
    ...
    // ISEN_C_M2
    ADC_setupSOC(MTR2_IW_ADC_BASE, ADC_SOC_NUMBER10, MTR2_ADC_TIGGER_SOC,
...
void HAL_setupGPIOs()
{
	...
	//  HALL
	//  M1
#if HALL_BLDC || HALL_FAST
		//  M1
	    {
	    // GPIO44->HA
	    GPIO_setPinConfig(MTR1_HALLBLDC_A_GPIO_MUX);
	    GPIO_setDirectionMode(MTR1_HALLBLDC_A_GPIO, GPIO_DIR_MODE_IN);
	    GPIO_setPadConfig(MTR1_HALLBLDC_A_GPIO, GPIO_PIN_TYPE_STD);

	    // GPIO37->HB
	    GPIO_setPinConfig(MTR1_HALLBLDC_B_GPIO_MUX);
	    GPIO_setDirectionMode(MTR1_HALLBLDC_B_GPIO, GPIO_DIR_MODE_IN);
	    GPIO_setPadConfig(MTR1_HALLBLDC_B_GPIO, GPIO_PIN_TYPE_STD);

	    // GPIO43->HC
	    GPIO_setPinConfig(MTR1_HALLBLDC_C_GPIO_MUX);
	    GPIO_setDirectionMode(MTR1_HALLBLDC_C_GPIO, GPIO_DIR_MODE_IN);
	    GPIO_setPadConfig(MTR1_HALLBLDC_C_GPIO, GPIO_PIN_TYPE_STD);
	    }

		//  M2
	    {
	    // GPIO6->HUX
	    GPIO_setPinConfig(MTR2_HALLBLDC_A_GPIO_MUX);
	    GPIO_setDirectionMode(MTR2_HALLBLDC_A_GPIO, GPIO_DIR_MODE_IN);
	    GPIO_setPadConfig(MTR2_HALLBLDC_A_GPIO, GPIO_PIN_TYPE_STD);

	    // GPIO10->HVX
	    GPIO_setPinConfig(MTR2_HALLBLDC_B_GPIO_MUX);
	    GPIO_setDirectionMode(MTR2_HALLBLDC_B_GPIO, GPIO_DIR_MODE_IN);
	    GPIO_setPadConfig(MTR2_HALLBLDC_B_GPIO, GPIO_PIN_TYPE_STD);

	    // GPIO9->HWX
	    GPIO_setPinConfig(MTR2_HALLBLDC_C_GPIO_MUX);
	    GPIO_setDirectionMode(MTR1_HALLBLDC_C_GPIO, GPIO_DIR_MODE_IN);
	    GPIO_setPadConfig(MTR1_HALLBLDC_C_GPIO, GPIO_PIN_TYPE_STD);
	    }
#endif
...
void HAL_setupTimeBaseTimer(HAL_Handle handle, const float32_t timeBaseFreq_Hz)
{
    ...
    CPUTimer_setEmulationMode(obj->timerHandle[2],CPUTIMER_EMULATIONMODE_RUNFREE);
    ...
    CPUTimer_setEmulationMode(obj->timerHandle[1],CPUTIMER_EMULATIONMODE_RUNFREE);

    CPUTimer_setPeriod(obj->timerHandle[1], 0xFFFFFFFF);
